const config = {
	...
	metaData: {
		title: 'Xinxin的个人主页🎉',
		description: '欢迎来到Xinxin的奇妙世界！',
		keywords: 'Xinxin,Xinxin,个人主页,个人网站',
	...
	projectcards: [
		{ go: "🚀 前往", img: "/img/sunshine.jpg", title: "博客", subtitle: "欢迎您的访问", text: "这博客怕是得了 写作拖延症 ，就像薛定谔的猫 --你不点进去 或许它正在偷偷酝酿一篇惊天动地的文章，只是还没找到灵感，或者干脆在摸鱼。总之，博客的门关得紧紧的，仿佛在说：今天不营业，改天再来吧！", url: "https://re-lighting.github.io/", show: false },
		...
		{ go: "📷 前往", img: "https://imgchr.com/i/pZ3Xi1H", title: "仑中", subtitle: "2024-2027北仑中学8班大家庭", text: "三载晴雨都收在这方教室———试卷边的余温，黑板上的光点，友善的同学，都是我们写给彼此青春的注脚。", url: "https://leleo.top", show: false },
		{ go: "🎇 前往", img: "https://imgchr.com/i/pZ3jpbq", title: "星星", subtitle: "1000000颗", text: "每一颗闪烁的星星都是宇宙写给你的一封情书。轻轻滑动指尖，便能穿越亿万光年的寂静，与无数温柔的光点悄然相会。", url: "https://stars.chromeexperiments.com/", show: false },
